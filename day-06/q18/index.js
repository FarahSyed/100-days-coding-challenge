...
var placesArr = ["Santorini", "Neelum Valley", "Kyoto", "The Colosseum", "Cape Town"];
...
console.log("In alphabetical order", __spreadArray([], placesArr, true).sort());
// Show that the array is still in its original order
console.log("Original Array", placesArr);
// Print array in reverse alphabetical order without changing the order of the original list.
console.log("Reversed alphabetical order", __spreadArray([], placesArr, true).sort().reverse());
// Show that the array is still in its original order
console.log("Original Array", placesArr);
